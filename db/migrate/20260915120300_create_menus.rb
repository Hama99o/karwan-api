class CreateMenus < ActiveRecord::Migration[8.1]
  def change
    ...
    add_index :menu_categories, [ :restaurant_id, :position ]

    create_table :menu_items do |t|
      # restaurant_id is denormalised from menu_category. It is what every
      ...
      # Nullable: falls back to the restaurant's prep_time_minutes.
    ...
    add_index :menu_items, [ :menu_category_id, :position ]
    add_index :menu_items, [ :restaurant_id, :is_available ]
    ...
    add_index :menu_item_options, [ :menu_item_id, :position ]

    create_table :menu_item_option_values do |t|
    ...
    add_index :menu_item_option_values, [ :menu_item_option_id, :position ]
  end
end
